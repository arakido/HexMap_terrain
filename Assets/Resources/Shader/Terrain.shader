// Upgrade NOTE: replaced 'defined data.mapData' with 'defined (data.mapData)'
// Upgrade NOTE: replaced 'defined o.Albedo' with 'defined (o.Albedo)'
...
Shader "Custom/Terrain" {
	Properties {
		...
		float4 GetTerrainColor(Input IN, int index) {
			float3 uvw = float3(IN.worldPos.xz * ( TILING_SCALE * 2 ), IN.terrain[index]);
